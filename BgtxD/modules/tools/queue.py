...
from BgtxD.utility import (BINNER, get_channeplayCB,
                              seconds_to_min)
from BgtxD.utility.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from BgtxD.utility.decorators.language import language, languageCB
from BgtxD.utility.buttons import queue_back_markup, queue_markup
